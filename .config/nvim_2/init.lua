...
-- A solution to copy selected from Neovim clipboard to OS clipboard (setting vim.opt.clipboard not working for some reason)
require 'clipboard'
vim.cmd [[
  augroup clip
    autocmd!
...
require('lazy').setup({
  ...
  { -- Markdown preview (install via yarn or npm)
